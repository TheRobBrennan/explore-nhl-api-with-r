...
GAME_DATA_CSV <- sprintf("%s/examples/Exploratory Data Analysis Using Tidyverse/assets/game_data.csv", getwd())
NATURAL_STAT_TRICK_DATA_CSV <- sprintf("%s/examples/Exploratory Data Analysis Using Tidyverse/assets/position_data_NST.csv", getwd())
